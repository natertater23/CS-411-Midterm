...
for i in ish.indices {
  print(String(format:"\0x%02x", ish[i].unicodeScalars.first!.value), terminator: " ")
}
...
func handleError(_ code: Int) {
  ...
  switch(code) {
    ...
    case 400...505: print("Server error/notherwise")
